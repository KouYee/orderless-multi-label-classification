...
from data import COCOMultiLabel
...
def main():
    ...
    train_dataset = COCOMultiLabel(train=True,classification=True,image_path=args.image_path)
    test_dataset = COCOMultiLabel(train=False,classification=True,image_path=args.image_path)
    train_loader = DataLoader(train_dataset,batch_size=args.batch_size,num_workers=args.num_workers,pin_memory=True,
                              shuffle=True,drop_last=False,collate_fn=my_collate)
